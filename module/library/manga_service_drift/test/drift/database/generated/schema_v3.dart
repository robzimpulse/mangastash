...
class DynamicSourceTables extends Table
    with TableInfo<DynamicSourceTables, DynamicSourceTablesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  DynamicSourceTables(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> createdAt = GeneratedColumn<int>(
    'created_at',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<i2.Uint8List> bytecode =
  ...
  @override
  DynamicSourceTablesData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return DynamicSourceTablesData(
      createdAt:
          attachedDatabase.typeMapping.read(
            DriftSqlType.int,
            data['${effectivePrefix}created_at'],
  ...
  @override
  DynamicSourceTables createAlias(String alias) {
    return DynamicSourceTables(attachedDatabase, alias);
  }
...
class DynamicSourceTablesData extends DataClass
    implements Insertable<DynamicSourceTablesData> {
  final int createdAt;
  final int updatedAt;
  final String id;
  final String name;
  ...
  final i2.Uint8List bytecode;
  final int isActive;
  const DynamicSourceTablesData({
    required this.createdAt,
    required this.updatedAt,
    required this.id,
    required this.name,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['bytecode'] = Variable<i2.Uint8List>(bytecode);
  ...
  factory DynamicSourceTablesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return DynamicSourceTablesData(
      ...
      bytecode: serializer.fromJson<i2.Uint8List>(json['bytecode']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'bytecode': serializer.toJson<i2.Uint8List>(bytecode),
      'isActive': serializer.toJson<int>(isActive),
    };
  }

  DynamicSourceTablesData copyWith({
    int? createdAt,
    int? updatedAt,
    String? id,
    String? name,
    ...
    String? sourceCode,
    i2.Uint8List? bytecode,
    int? isActive,
  }) => DynamicSourceTablesData(
    createdAt: createdAt ?? this.createdAt,
    updatedAt: updatedAt ?? this.updatedAt,
    id: id ?? this.id,
    name: name ?? this.name,
  ...
  DynamicSourceTablesData copyWithCompanion(DynamicSourceTablesCompanion data) {
    return DynamicSourceTablesData(
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('DynamicSourceTablesData(')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('id: $id, ')
          ..write('name: $name, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is DynamicSourceTablesData &&
          other.createdAt == this.createdAt &&
          other.updatedAt == this.updatedAt &&
          other.id == this.id &&
          other.name == this.name &&
...
class DynamicSourceTablesCompanion
    extends UpdateCompanion<DynamicSourceTablesData> {
  final Value<int> createdAt;
  final Value<int> updatedAt;
  final Value<String> id;
  final Value<String> name;
  ...
  final Value<i2.Uint8List> bytecode;
  ...
  DynamicSourceTablesCompanion.insert({
    ...
    required i2.Uint8List bytecode,
    this.isActive = const Value.absent(),
    this.rowid = const Value.absent(),
  }) : createdAt = Value(createdAt),
       updatedAt = Value(updatedAt),
       ...
       sourceCode = Value(sourceCode),
       bytecode = Value(bytecode);
  static Insertable<DynamicSourceTablesData> custom({
    Expression<int>? createdAt,
    Expression<int>? updatedAt,
    Expression<String>? id,
    Expression<String>? name,
    ...
    Expression<i2.Uint8List>? bytecode,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (bytecode.present) {
      map['bytecode'] = Variable<i2.Uint8List>(bytecode.value);
    }
    if (isActive.present) {
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final DynamicSourceTables dynamicSourceTables = DynamicSourceTables(
    this,
  );
  @override
