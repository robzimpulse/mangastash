...
final class Schema3 extends i0.VersionedSchema {
  ...
  late final Shape8 customSourceTables = Shape8(
    source: i0.VersionedTable(
      entityName: 'custom_source_tables',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: [],
      columns: [
...
class Shape8 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get scriptUrl =>
      columnsByName['script_url']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get scriptCode =>
      columnsByName['script_code']! as i1.GeneratedColumn<String>;
}
