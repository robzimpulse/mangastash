...
final class Schema3 extends i0.VersionedSchema {
  ...
  late final Shape8 dynamicSourceTables = Shape8(
    source: i0.VersionedTable(
      entityName: 'dynamic_source_tables',
      withoutRowId: false,
      isStrict: false,
      tableConstraints: ['PRIMARY KEY(id)', 'UNIQUE(name)', 'UNIQUE(base_url)'],
      columns: [
        _column_0,
        _column_1,
        _column_2,
...
class Shape8 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get sourceCode =>
      columnsByName['source_code']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<i2.Uint8List> get bytecode =>
      columnsByName['bytecode']! as i1.GeneratedColumn<i2.Uint8List>;
