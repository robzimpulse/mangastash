...
class ScanlationsResultData {
  ...
  ScanlationsResultData(this.id, this.type, this.attributes, this.relationships);
  factory ScanlationsResultData.fromJson(Map<String, dynamic> json) => _$ScanlationsResultDataFromJson(json);
...
class ScanlationsResultRelationShip {
  ...
  ScanlationsResultRelationShip(this.id, this.type, this.refinald, this.attributes);
