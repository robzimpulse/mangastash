...
class $ChapterScrapped extends $Value implements $Instance {
  static const $type = BridgeTypeRef(
    BridgeTypeSpec('package:entity_manga_external/src/chapter_scrapped.dart', 'ChapterScrapped'),
  );
  ...
  static const $declaration = BridgeClassDef(
      ...
      '': BridgeConstructorDef(
        BridgeFunctionDef(
          ...
          namedParams: [
            ...
            BridgeParameter('mangaId', BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String'))), true),
            BridgeParameter('title', BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String'))), true),
            BridgeParameter('volume', BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String'))), true),
            BridgeParameter('chapter', BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String'))), true),
            BridgeParameter('readableAt', BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String'))), true),
            BridgeParameter('publishAt', BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String'))), true),
            BridgeParameter('images', BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'List'))), true),
            BridgeParameter('translatedLanguage', BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String'))), true),
            BridgeParameter('scanlationGroup', BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String'))), true),
            BridgeParameter('webUrl', BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String'))), true),
            BridgeParameter('lastReadAt', BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String'))), true),
    ...
    fields: {
      ...
      'mangaId': BridgeFieldDef(BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String')), nullable: true)),
      'title': BridgeFieldDef(BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String')), nullable: true)),
      'volume': BridgeFieldDef(BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String')), nullable: true)),
      'chapter': BridgeFieldDef(BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String')), nullable: true)),
      'readableAt': BridgeFieldDef(BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String')), nullable: true)),
      'publishAt': BridgeFieldDef(BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String')), nullable: true)),
      'images': BridgeFieldDef(BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'List')), nullable: true)),
      'translatedLanguage': BridgeFieldDef(BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String')), nullable: true)),
      'scanlationGroup': BridgeFieldDef(BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String')), nullable: true)),
      'webUrl': BridgeFieldDef(BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String')), nullable: true)),
      'lastReadAt': BridgeFieldDef(BridgeTypeAnnotation(BridgeTypeRef(BridgeTypeSpec('dart:core', 'String')), nullable: true)),
