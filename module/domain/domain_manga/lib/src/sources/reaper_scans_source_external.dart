...
/// Reaper Scans (https://reaperscans.co.in) external manga source.
///
/// The site is a WordPress blog running the **newsmatic** theme publishing
/// casino/anime posts — it is not a manga site and carries no Madara theme
/// markers. This implementation follows the generic Madara selector set used
/// by the other scanned sources (search cards, detail rows, chapter list,
/// reader lazyload) so it compiles and is testable against fixtures.
/// ponytail: real reaperscans domain unverified (site is a WordPress newsmatic
/// blog, not manga); selectors are Madara-convention guesses; live smoke test
/// required.
class ReaperScansSourceExternal implements SourceExternal {
  @override
  String get baseUrl => 'https://reaperscans.co.in';
...
class _SearchMangaSourceExternalUseCase
  ...
  Future<bool?> haveNextPage({required Document root}) async {
    ...
    if (root.querySelector('a.next.page-numbers') != null) return true;
